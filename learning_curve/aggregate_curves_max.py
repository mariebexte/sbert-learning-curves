...
def prompt_curve(prompt_dir, dataset_name, sampling_strategy, eval_measure):
    ...
    for method in os.listdir(os.path.join(prompt_dir)):
        if os.path.isdir(os.path.join(prompt_dir, method)):
            ...
            if os.path.exists(results_path):
                ...
                method_results_avg = get_max(method_results)
                ...
                if method == "SBERT":
                    ...
                    if os.path.exists(results_path_max):
                        ...
                        method_results_max_avg = get_max(method_results_max)
    ...
    plt.savefig(os.path.join(prompt_dir, dataset_name+"_"+sampling_strategy+"_"+prompt_name+"_method-comparison_BEST.png"))
 
    plt.clf()
    plt.cla()
    plt.close()

    prompt_results.to_csv(os.path.join(prompt_dir, dataset_name+"_"+sampling_strategy+"_"+prompt_name+"_method-comparison_BEST.csv"), index=None)
...
def strategy_curve(strategy_path, dataset_name, eval_measure):
    ...
    for method in method_results_dict:
        ...
        method_overview_df.to_csv(os.path.join(strategy_path, dataset_name+"_"+sampling_strategy+"_"+method+"_prompt-comparison_BEST.csv"), index=None)
    ...
    support_df.to_csv(os.path.join(strategy_path, dataset_name+"_"+sampling_strategy+"_support_BEST.csv"), index=None)

    # Save method overview df to csv
    overview_df.to_csv(os.path.join(strategy_path, dataset_name+"_"+sampling_strategy+"_method-comparison_BEST.csv"),index=None)
    ...
    plt.savefig(os.path.join(strategy_path, dataset_name+"_"+sampling_strategy+"_method-comparison_BEST.png"))
...
def dataset_curve(dataset_path, eval_measure):
    ...
    overall_results.to_csv(os.path.join(dataset_path, dataset_name+"_strategy_comparison_BEST.csv"), index=None)
    ...
    plt.savefig(os.path.join(dataset_path, dataset_name+"_strategy_comparison_BEST.png"))
