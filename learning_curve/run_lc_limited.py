...
def run_limited(dataset_name, prompt_name, train_path, val_path, test_path, method, eval_measure, sampling_strategy, num_labels, max_size=None, upsample_training=False, num_samples=20, predetermined_train_sizes=None):
        ...
        for train_size in train_sizes:
            ...
            for sample in range(num_samples):
                ...
                if method in ["LR", "RF", "SVM"]:
                    ...
                    y_pred_max, y_pred = train_sbert_limited(run_path=run_path, df_train=df_train_subset, df_val=df_val, df_test=df_test)
