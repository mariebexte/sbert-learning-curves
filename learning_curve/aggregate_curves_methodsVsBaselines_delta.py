...
colors = {"BERT_old": "green", "BERT_new": "orange", "BERT_old_save2": "green", "BERT_new_save2": "blue", "SBERT_noval": "deepskyblue", "BERT_10e": "red", "BERT_oldConfig": "red", "SBERT_wrongVal": "lime", "SBERT_wrongVal_max": "deepskyblue", "SBERT_valFixed": "lime", "SBERT_max": "pink", "SBERT": "red", "LR": "blue", "RF": "green", "SVM": "orange", "BERT": "purple",
          ...
          "edit": "green", "edit_max": "green", "overlap": "turquoise", "overlap_max": "turquoise", "cosine": "orange", "cosine_max": "orange", "pretrained": "deepskyblue", "pretrained_max": "deepskyblue"}
# Predefined line styles for the different sampling strategies          
strategies = {"BERT": "-", "LR": '-', "SBERT": "-", "SBERT_max": "-", "edit_max": "--", "overlap_max": "--", "cosine_max": "--", "pretrained_max": "--"}
...
def get_diff_best_worst(df, eval_metric):

    df_max = np.nanmax(df, axis=0)
    df_min = np.nanmin(df, axis=0)
...
def prompt_curve(prompt_dir, dataset_name, sampling_strategy, eval_measure):
        ...
        if os.path.isdir(os.path.join(prompt_dir, method)):
            ...
            if os.path.exists(results_path):
                ...
                if method in ["SBERT", "BERT", "LR"]:
                    ...
                    method_results_avg = get_diff_best_worst(method_results, eval_measure)
                ...
                if method in ["SBERT", "edit", "overlap", "cosine", "pretrained"]:
                    ...
                    if os.path.exists(results_path_max):
                        ...
                        method_results_max_avg = get_diff_best_worst(method_results_max, eval_measure)
    ...
    plt.ylabel("Max diff "+eval_measure, fontsize=20)
...
dataset_curve("TOTAL_RESULTS_REDUCED_diff-best-worst/ASAP", "QWK")
dataset_curve("TOTAL_RESULTS_REDUCED_diff-best-worst/SEB/SRA_5way", "weighted_f1")
dataset_curve("TOTAL_RESULTS_REDUCED_diff-best-worst/SEB/SRA_2way", "weighted_f1")
dataset_curve("TOTAL_RESULTS_REDUCED_diff-best-worst/Beetle/SRA_5way", "weighted_f1")
dataset_curve("TOTAL_RESULTS_REDUCED_diff-best-worst/Beetle/SRA_2way", "weighted_f1")
